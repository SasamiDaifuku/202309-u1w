...
public class ConversationUI : MonoBehaviour
{
    ...
    public void SpeakStoryConversation()
    {
        DOTween.Sequence()
            ...
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "なにせ、死ぬのは初めてなんでな"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "お前が何者か知らないけど"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "よろしくたのむぜ..."; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            ...
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "跳ねるのはいいけどよ"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "歩いたりはまっぴらごめんだぜ"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "疲れるからな"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "死んでるのに疲れるのかよとか思ったか？"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "それはお前...気持ちの問題ってやつよ"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            ...
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
            .AppendCallback(() => { speakText.text = "死んじまって時間はたっぷりあるからよ"; })
            .Append(GetComponent<CanvasGroup>().DOFade(1.0f, 0.5f))
            .AppendInterval(FADE_MESSAGE_INTERVAL)
            .Append(GetComponent<CanvasGroup>().DOFade(0.0f, 1.0f))
            .AppendInterval(NEXT_MESSAGE_INTERVAL)
